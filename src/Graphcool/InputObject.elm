...
encodeCreateChallenge (CreateChallenge input) =
    Encode.maybeObject
        [ ( "activeFrom", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.activeFrom ), ( "activeTo", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.activeTo ), ( "answer", Encode.string input.answer |> Just ), ( "discussionUrl", Encode.string |> Encode.optional input.discussionUrl ), ( "markdown", Encode.string input.markdown |> Just ), ( "markup", Encode.string input.markup |> Just ), ( "published", Encode.bool |> Encode.optional input.published ), ( "title", Encode.string input.title |> Just ), ( "solutionsIds", ((Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.solutionsIds ), ( "solutions", (encodeChallengesolutionsSolution |> Encode.list) |> Encode.optional input.solutions ) ]
...
buildCreateUser : CreateUserRequiredFields -> (CreateUserOptionalFields -> CreateUserOptionalFields) -> CreateUser
buildCreateUser required fillOptionals =
    let
        optionals =
            fillOptionals
                { role = Absent, solutionsIds = Absent, solutions = Absent }
    in
    CreateUser { auth0UserId = required.auth0UserId, nickname = required.nickname, picture = required.picture, role = optionals.role, solutionsIds = optionals.solutionsIds, solutions = optionals.solutions }


type alias CreateUserRequiredFields =
    { auth0UserId : String
    , nickname : String
    , picture : String
    }
...
encodeCreateUser (CreateUser input) =
    Encode.maybeObject
        [ ( "auth0UserId", Encode.string input.auth0UserId |> Just ), ( "nickname", Encode.string input.nickname |> Just ), ( "picture", Encode.string input.picture |> Just ), ( "role", Encode.enum Graphcool.Enum.UserRole.toString |> Encode.optional input.role ), ( "solutionsIds", ((Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.solutionsIds ), ( "solutions", (encodeUsersolutionsSolution |> Encode.list) |> Encode.optional input.solutions ) ]
...
buildSolutionuserUser : SolutionuserUserRequiredFields -> (SolutionuserUserOptionalFields -> SolutionuserUserOptionalFields) -> SolutionuserUser
buildSolutionuserUser required fillOptionals =
    let
        optionals =
            fillOptionals
                { role = Absent, solutionsIds = Absent, solutions = Absent }
    in
    SolutionuserUser { auth0UserId = required.auth0UserId, nickname = required.nickname, picture = required.picture, role = optionals.role, solutionsIds = optionals.solutionsIds, solutions = optionals.solutions }


type alias SolutionuserUserRequiredFields =
    { auth0UserId : String
    , nickname : String
    , picture : String
    }
...
buildUpdateChallenge required fillOptionals =
    let
        optionals =
            fillOptionals
                { activeFrom = Absent, activeTo = Absent, answer = Absent, discussionUrl = Absent, markdown = Absent, markup = Absent, published = Absent, title = Absent, solutionsIds = Absent, solutions = Absent }
    in
    UpdateChallenge { activeFrom = optionals.activeFrom, activeTo = optionals.activeTo, answer = optionals.answer, discussionUrl = optionals.discussionUrl, id = required.id, markdown = optionals.markdown, markup = optionals.markup, published = optionals.published, title = optionals.title, solutionsIds = optionals.solutionsIds, solutions = optionals.solutions }
...
buildUpdateUser required fillOptionals =
    let
        optionals =
            fillOptionals
                { auth0UserId = Absent, nickname = Absent, picture = Absent, role = Absent, solutionsIds = Absent, solutions = Absent }
    in
    UpdateUser { auth0UserId = optionals.auth0UserId, id = required.id, nickname = optionals.nickname, picture = optionals.picture, role = optionals.role, solutionsIds = optionals.solutionsIds, solutions = optionals.solutions }
...
encodeUpdateUser (UpdateUser input) =
    Encode.maybeObject
        [ ( "auth0UserId", Encode.string |> Encode.optional input.auth0UserId ), ( "id", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) input.id |> Just ), ( "nickname", Encode.string |> Encode.optional input.nickname ), ( "picture", Encode.string |> Encode.optional input.picture ), ( "role", Encode.enum Graphcool.Enum.UserRole.toString |> Encode.optional input.role ), ( "solutionsIds", ((Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.solutionsIds ), ( "solutions", (encodeUsersolutionsSolution |> Encode.list) |> Encode.optional input.solutions ) ]
...
buildUserFilter fillOptionals =
    let
        optionals =
            fillOptionals
                { and = Absent, or = Absent, auth0UserId = Absent, auth0UserId_not = Absent, auth0UserId_in = Absent, auth0UserId_not_in = Absent, auth0UserId_lt = Absent, auth0UserId_lte = Absent, auth0UserId_gt = Absent, auth0UserId_gte = Absent, auth0UserId_contains = Absent, auth0UserId_not_contains = Absent, auth0UserId_starts_with = Absent, auth0UserId_not_starts_with = Absent, auth0UserId_ends_with = Absent, auth0UserId_not_ends_with = Absent, createdAt = Absent, createdAt_not = Absent, createdAt_in = Absent, createdAt_not_in = Absent, createdAt_lt = Absent, createdAt_lte = Absent, createdAt_gt = Absent, createdAt_gte = Absent, id = Absent, id_not = Absent, id_in = Absent, id_not_in = Absent, id_lt = Absent, id_lte = Absent, id_gt = Absent, id_gte = Absent, id_contains = Absent, id_not_contains = Absent, id_starts_with = Absent, id_not_starts_with = Absent, id_ends_with = Absent, id_not_ends_with = Absent, nickname = Absent, nickname_not = Absent, nickname_in = Absent, nickname_not_in = Absent, nickname_lt = Absent, nickname_lte = Absent, nickname_gt = Absent, nickname_gte = Absent, nickname_contains = Absent, nickname_not_contains = Absent, nickname_starts_with = Absent, nickname_not_starts_with = Absent, nickname_ends_with = Absent, nickname_not_ends_with = Absent, picture = Absent, picture_not = Absent, picture_in = Absent, picture_not_in = Absent, picture_lt = Absent, picture_lte = Absent, picture_gt = Absent, picture_gte = Absent, picture_contains = Absent, picture_not_contains = Absent, picture_starts_with = Absent, picture_not_starts_with = Absent, picture_ends_with = Absent, picture_not_ends_with = Absent, role = Absent, role_not = Absent, role_in = Absent, role_not_in = Absent, updatedAt = Absent, updatedAt_not = Absent, updatedAt_in = Absent, updatedAt_not_in = Absent, updatedAt_lt = Absent, updatedAt_lte = Absent, updatedAt_gt = Absent, updatedAt_gte = Absent, solutions_every = Absent, solutions_some = Absent, solutions_none = Absent }
    in
    UserFilter { and = optionals.and, or = optionals.or, auth0UserId = optionals.auth0UserId, auth0UserId_not = optionals.auth0UserId_not, auth0UserId_in = optionals.auth0UserId_in, auth0UserId_not_in = optionals.auth0UserId_not_in, auth0UserId_lt = optionals.auth0UserId_lt, auth0UserId_lte = optionals.auth0UserId_lte, auth0UserId_gt = optionals.auth0UserId_gt, auth0UserId_gte = optionals.auth0UserId_gte, auth0UserId_contains = optionals.auth0UserId_contains, auth0UserId_not_contains = optionals.auth0UserId_not_contains, auth0UserId_starts_with = optionals.auth0UserId_starts_with, auth0UserId_not_starts_with = optionals.auth0UserId_not_starts_with, auth0UserId_ends_with = optionals.auth0UserId_ends_with, auth0UserId_not_ends_with = optionals.auth0UserId_not_ends_with, createdAt = optionals.createdAt, createdAt_not = optionals.createdAt_not, createdAt_in = optionals.createdAt_in, createdAt_not_in = optionals.createdAt_not_in, createdAt_lt = optionals.createdAt_lt, createdAt_lte = optionals.createdAt_lte, createdAt_gt = optionals.createdAt_gt, createdAt_gte = optionals.createdAt_gte, id = optionals.id, id_not = optionals.id_not, id_in = optionals.id_in, id_not_in = optionals.id_not_in, id_lt = optionals.id_lt, id_lte = optionals.id_lte, id_gt = optionals.id_gt, id_gte = optionals.id_gte, id_contains = optionals.id_contains, id_not_contains = optionals.id_not_contains, id_starts_with = optionals.id_starts_with, id_not_starts_with = optionals.id_not_starts_with, id_ends_with = optionals.id_ends_with, id_not_ends_with = optionals.id_not_ends_with, nickname = optionals.nickname, nickname_not = optionals.nickname_not, nickname_in = optionals.nickname_in, nickname_not_in = optionals.nickname_not_in, nickname_lt = optionals.nickname_lt, nickname_lte = optionals.nickname_lte, nickname_gt = optionals.nickname_gt, nickname_gte = optionals.nickname_gte, nickname_contains = optionals.nickname_contains, nickname_not_contains = optionals.nickname_not_contains, nickname_starts_with = optionals.nickname_starts_with, nickname_not_starts_with = optionals.nickname_not_starts_with, nickname_ends_with = optionals.nickname_ends_with, nickname_not_ends_with = optionals.nickname_not_ends_with, picture = optionals.picture, picture_not = optionals.picture_not, picture_in = optionals.picture_in, picture_not_in = optionals.picture_not_in, picture_lt = optionals.picture_lt, picture_lte = optionals.picture_lte, picture_gt = optionals.picture_gt, picture_gte = optionals.picture_gte, picture_contains = optionals.picture_contains, picture_not_contains = optionals.picture_not_contains, picture_starts_with = optionals.picture_starts_with, picture_not_starts_with = optionals.picture_not_starts_with, picture_ends_with = optionals.picture_ends_with, picture_not_ends_with = optionals.picture_not_ends_with, role = optionals.role, role_not = optionals.role_not, role_in = optionals.role_in, role_not_in = optionals.role_not_in, updatedAt = optionals.updatedAt, updatedAt_not = optionals.updatedAt_not, updatedAt_in = optionals.updatedAt_in, updatedAt_not_in = optionals.updatedAt_not_in, updatedAt_lt = optionals.updatedAt_lt, updatedAt_lte = optionals.updatedAt_lte, updatedAt_gt = optionals.updatedAt_gt, updatedAt_gte = optionals.updatedAt_gte, solutions_every = optionals.solutions_every, solutions_some = optionals.solutions_some, solutions_none = optionals.solutions_none }
...
type alias UserFilterOptionalFields =
    ...
    , id_not_ends_with : OptionalArgument Graphcool.ScalarCodecs.Id
    , nickname : OptionalArgument String
    , nickname_not : OptionalArgument String
    , nickname_in : OptionalArgument (List String)
    , nickname_not_in : OptionalArgument (List String)
    , nickname_lt : OptionalArgument String
    , nickname_lte : OptionalArgument String
    , nickname_gt : OptionalArgument String
    , nickname_gte : OptionalArgument String
    , nickname_contains : OptionalArgument String
    , nickname_not_contains : OptionalArgument String
    , nickname_starts_with : OptionalArgument String
    , nickname_not_starts_with : OptionalArgument String
    , nickname_ends_with : OptionalArgument String
    , nickname_not_ends_with : OptionalArgument String
    , picture : OptionalArgument String
    , picture_not : OptionalArgument String
    , picture_in : OptionalArgument (List String)
    , picture_not_in : OptionalArgument (List String)
    , picture_lt : OptionalArgument String
    , picture_lte : OptionalArgument String
    , picture_gt : OptionalArgument String
    , picture_gte : OptionalArgument String
    , picture_contains : OptionalArgument String
    , picture_not_contains : OptionalArgument String
    , picture_starts_with : OptionalArgument String
    , picture_not_starts_with : OptionalArgument String
    , picture_ends_with : OptionalArgument String
    , picture_not_ends_with : OptionalArgument String
    , role : OptionalArgument Graphcool.Enum.UserRole.UserRole
...
encodeUserFilter (UserFilter input) =
    Encode.maybeObject
        [ ( "AND", (encodeUserFilter |> Encode.list) |> Encode.optional input.and ), ( "OR", (encodeUserFilter |> Encode.list) |> Encode.optional input.or ), ( "auth0UserId", Encode.string |> Encode.optional input.auth0UserId ), ( "auth0UserId_not", Encode.string |> Encode.optional input.auth0UserId_not ), ( "auth0UserId_in", (Encode.string |> Encode.list) |> Encode.optional input.auth0UserId_in ), ( "auth0UserId_not_in", (Encode.string |> Encode.list) |> Encode.optional input.auth0UserId_not_in ), ( "auth0UserId_lt", Encode.string |> Encode.optional input.auth0UserId_lt ), ( "auth0UserId_lte", Encode.string |> Encode.optional input.auth0UserId_lte ), ( "auth0UserId_gt", Encode.string |> Encode.optional input.auth0UserId_gt ), ( "auth0UserId_gte", Encode.string |> Encode.optional input.auth0UserId_gte ), ( "auth0UserId_contains", Encode.string |> Encode.optional input.auth0UserId_contains ), ( "auth0UserId_not_contains", Encode.string |> Encode.optional input.auth0UserId_not_contains ), ( "auth0UserId_starts_with", Encode.string |> Encode.optional input.auth0UserId_starts_with ), ( "auth0UserId_not_starts_with", Encode.string |> Encode.optional input.auth0UserId_not_starts_with ), ( "auth0UserId_ends_with", Encode.string |> Encode.optional input.auth0UserId_ends_with ), ( "auth0UserId_not_ends_with", Encode.string |> Encode.optional input.auth0UserId_not_ends_with ), ( "createdAt", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.createdAt ), ( "createdAt_not", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.createdAt_not ), ( "createdAt_in", ((Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.list) |> Encode.optional input.createdAt_in ), ( "createdAt_not_in", ((Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.list) |> Encode.optional input.createdAt_not_in ), ( "createdAt_lt", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.createdAt_lt ), ( "createdAt_lte", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.createdAt_lte ), ( "createdAt_gt", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.createdAt_gt ), ( "createdAt_gte", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.createdAt_gte ), ( "id", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id ), ( "id_not", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id_not ), ( "id_in", ((Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.id_in ), ( "id_not_in", ((Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.list) |> Encode.optional input.id_not_in ), ( "id_lt", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id_lt ), ( "id_lte", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id_lte ), ( "id_gt", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id_gt ), ( "id_gte", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id_gte ), ( "id_contains", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id_contains ), ( "id_not_contains", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id_not_contains ), ( "id_starts_with", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id_starts_with ), ( "id_not_starts_with", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id_not_starts_with ), ( "id_ends_with", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id_ends_with ), ( "id_not_ends_with", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecId) |> Encode.optional input.id_not_ends_with ), ( "nickname", Encode.string |> Encode.optional input.nickname ), ( "nickname_not", Encode.string |> Encode.optional input.nickname_not ), ( "nickname_in", (Encode.string |> Encode.list) |> Encode.optional input.nickname_in ), ( "nickname_not_in", (Encode.string |> Encode.list) |> Encode.optional input.nickname_not_in ), ( "nickname_lt", Encode.string |> Encode.optional input.nickname_lt ), ( "nickname_lte", Encode.string |> Encode.optional input.nickname_lte ), ( "nickname_gt", Encode.string |> Encode.optional input.nickname_gt ), ( "nickname_gte", Encode.string |> Encode.optional input.nickname_gte ), ( "nickname_contains", Encode.string |> Encode.optional input.nickname_contains ), ( "nickname_not_contains", Encode.string |> Encode.optional input.nickname_not_contains ), ( "nickname_starts_with", Encode.string |> Encode.optional input.nickname_starts_with ), ( "nickname_not_starts_with", Encode.string |> Encode.optional input.nickname_not_starts_with ), ( "nickname_ends_with", Encode.string |> Encode.optional input.nickname_ends_with ), ( "nickname_not_ends_with", Encode.string |> Encode.optional input.nickname_not_ends_with ), ( "picture", Encode.string |> Encode.optional input.picture ), ( "picture_not", Encode.string |> Encode.optional input.picture_not ), ( "picture_in", (Encode.string |> Encode.list) |> Encode.optional input.picture_in ), ( "picture_not_in", (Encode.string |> Encode.list) |> Encode.optional input.picture_not_in ), ( "picture_lt", Encode.string |> Encode.optional input.picture_lt ), ( "picture_lte", Encode.string |> Encode.optional input.picture_lte ), ( "picture_gt", Encode.string |> Encode.optional input.picture_gt ), ( "picture_gte", Encode.string |> Encode.optional input.picture_gte ), ( "picture_contains", Encode.string |> Encode.optional input.picture_contains ), ( "picture_not_contains", Encode.string |> Encode.optional input.picture_not_contains ), ( "picture_starts_with", Encode.string |> Encode.optional input.picture_starts_with ), ( "picture_not_starts_with", Encode.string |> Encode.optional input.picture_not_starts_with ), ( "picture_ends_with", Encode.string |> Encode.optional input.picture_ends_with ), ( "picture_not_ends_with", Encode.string |> Encode.optional input.picture_not_ends_with ), ( "role", Encode.enum Graphcool.Enum.UserRole.toString |> Encode.optional input.role ), ( "role_not", Encode.enum Graphcool.Enum.UserRole.toString |> Encode.optional input.role_not ), ( "role_in", (Encode.enum Graphcool.Enum.UserRole.toString |> Encode.list) |> Encode.optional input.role_in ), ( "role_not_in", (Encode.enum Graphcool.Enum.UserRole.toString |> Encode.list) |> Encode.optional input.role_not_in ), ( "updatedAt", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.updatedAt ), ( "updatedAt_not", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.updatedAt_not ), ( "updatedAt_in", ((Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.list) |> Encode.optional input.updatedAt_in ), ( "updatedAt_not_in", ((Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.list) |> Encode.optional input.updatedAt_not_in ), ( "updatedAt_lt", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.updatedAt_lt ), ( "updatedAt_lte", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.updatedAt_lte ), ( "updatedAt_gt", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.updatedAt_gt ), ( "updatedAt_gte", (Graphcool.ScalarCodecs.codecs |> Graphcool.Scalar.unwrapEncoder .codecDateTime) |> Encode.optional input.updatedAt_gte ), ( "solutions_every", encodeSolutionFilter |> Encode.optional input.solutions_every ), ( "solutions_some", encodeSolutionFilter |> Encode.optional input.solutions_some ), ( "solutions_none", encodeSolutionFilter |> Encode.optional input.solutions_none ) ]
